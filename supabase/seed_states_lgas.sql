-- HAID Watch — State & LGA seed data
-- Source: public administrative dataset, cross-checked against Wikipedia's
-- 'Local government areas of Nigeria' (36 states + FCT, 774 LGAs total).
-- Run this AFTER supabase/schema.sql. Wards and Polling Units are intentionally
-- left for a later pass — that data is far larger (~8,800 wards, 176,000+ PUs)
-- and best sourced from INEC directly for accuracy at that granularity.
...
-- LGAs, linked to their state by name lookup
